# Paper-Database-Assistant
在Academic Paper PDF Batch Downloader (https://github.com/GaryCao-45/Academic-Paper-PDF-Batch-Downloader) 的基础上，加装了LLM Auto Feature Extract功能，可调用API和自定义提示词进行结构化数据集全自动生成。具体操作可参考使用说明书，因为本人的模型调用习惯，目前该助手仅支持Google AI Studio和Openrouter的API key。
